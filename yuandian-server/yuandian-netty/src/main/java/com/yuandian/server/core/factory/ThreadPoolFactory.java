...
public class ThreadPoolFactory {
    protected static final Logger _log = LoggerFactory.getLogger(ThreadPoolFactory.class);
    ...
    protected ThreadPoolFactory() {
        ...
        _generalScheduledThreadPool = new ScheduledThreadPoolExecutor(5);
        _eventScheduledThreadPool = new ScheduledThreadPoolExecutor(5);
    ...
    private static class SingletonHolder {
        protected static final ThreadPoolFactory _instance = new ThreadPoolFactory();
    }
}