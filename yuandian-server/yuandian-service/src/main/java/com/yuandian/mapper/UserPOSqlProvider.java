...
import com.yuandian.entity.UserPOExample.Criteria;
import com.yuandian.entity.UserPOExample.Criterion;
...
public class UserPOSqlProvider {
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getAlipay() != null) {
            SET("alipay = #{record.alipay,jdbcType=VARCHAR}");
        }
    ...
    protected void applyWhere(UserPOExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
